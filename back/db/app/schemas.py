...
class BusinessProfileCreate(BaseModel):
    ...
    annual_sales: int = Field(default=0, ge=0)


class BusinessProfileUpdate(BaseModel):
    business_name: str | None = Field(default=None, min_length=1, max_length=100)
    owner_name: str | None = Field(default=None, min_length=1, max_length=50)
    region_name: str | None = Field(default=None, max_length=50)
    industry_name: str | None = Field(default=None, max_length=100)
    annual_sales: int | None = Field(default=None, ge=0)
...
class SupportProgramCreate(BaseModel):
    ...
    support_type: str | None = Field(default=None, max_length=50)
    support_amount: int = Field(default=0, ge=0)
...
class FundingRequestCreate(BaseModel):
    ...
    funding_purpose: str = Field(min_length=1, max_length=50)
    self_funding_amount: int = Field(default=0, ge=0)
    max_monthly_payment: int = Field(default=0, ge=0)
    optimization_priority: str = Field(default="비용", min_length=1, max_length=30)


class FundingRequestUpdate(BaseModel):
    required_amount: int | None = Field(default=None, gt=0)
    funding_purpose: str | None = Field(default=None, min_length=1, max_length=50)
    self_funding_amount: int | None = Field(default=None, ge=0)
    max_monthly_payment: int | None = Field(default=None, ge=0)
    optimization_priority: str | None = Field(default=None, min_length=1, max_length=30)
...
class PortfolioSelectionItemCreate(BaseModel):
    source_type: Literal[
        "support_program",
        "loan_product",
        "self_funding",
...
class PortfolioCreate(BaseModel):
    ...
    selections: list[PortfolioSelectionItemCreate] = Field(min_length=1)
...
class PortfolioResultResponse(BaseModel):
    ...
    finance_cost: int
    expected_period_weeks: int
    expected_period_label: str | None
    is_ai_recommended: bool
    recommendation_reason: str | None

    stress_test_result: list[dict[str, Any]] = Field(
