...
const settings = [
  ...
  {
    label: "관심 사업 조기 마감",
    icon: "/interest/interest-early.svg",
  },
  { label: "신규 지원사업", marker: "NEW", markerTone: "new" },
  {
    label: "추가 모집",
    icon: "/interest/interest-megaphone.svg",
  },
];
        ...
        <header className="interest-header">
          <div className="interest-header-left">
            <Link href="/service" className="icon-button" aria-label="이전 화면으로 이동">
              <Image src="/interest/interest-header-back.svg" alt="" width={24} height={24} />
            </Link>
            <h1>KB BizMate AI</h1>
          </div>
          <div className="interest-header-actions">
            <button className="icon-button" type="button" aria-label="검색">
              <Image src="/interest/interest-search.svg" alt="" width={24} height={24} />
            </button>
            <Link href="/" className="icon-button" aria-label="홈으로 이동">
              <Image src="/interest/interest-home.svg" alt="" width={24} height={24} />
            </Link>
            <button className="icon-button" type="button" aria-label="메뉴 열기">
              <Image src="/interest/interest-menu.svg" alt="" width={24} height={24} />
            </button>
          </div>
        </header>
        ...
        <div className="interest-content">
          <section className="interest-hero" aria-labelledby="interest-hero-title">
            <div className="interest-hero-copy">
              <div className="interest-hero-title-row">
                <div className="interest-hero-icon">
                  <Image src="/interest/interest-hero-bell.svg" alt="" width={24} height={24} />
                </div>
            ...
            <div className="interest-hero-image">
              <Image src="/interest/interest-hero.png" alt="" width={433} height={650} priority />
            </div>
          </section>
          ...
          <section className="interest-preview" aria-labelledby="preview-title">
              ...
              {previewCards.map((card) => (
                <article className="preview-card" key={card.title}>
                  <div className="preview-title">
                    <Image src="/interest/interest-small-bell.svg" alt="" width={12} height={11} />
            ...
            <div className="preview-note">
              <Image src="/interest/interest-info.svg" alt="" width={16} height={16} />
